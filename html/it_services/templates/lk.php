		...
		<div class="row">
			<div class="col-sm-7">
				...
				<p class="contact-us-details">
					<b>Адрес:</b> 123 Fake Street, LN1 2ST, London, United Kingdom<br />
					<b>Тел.:</b> +44 123 654321<br />
					<b>Почта:</b> <a href="mailto:getintoutch@yourcompanydomain.com">getintoutch@yourcompanydomain.com</a><br />
					<b>Skype:</b> <br />
				</p>
				<!-- End Contact Info -->
			</div>
